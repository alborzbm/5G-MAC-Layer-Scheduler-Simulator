...
1.  **Clone the repository and navigate to the folder:**
    ```bash
    git clone [https://github.com/alborzbm/5g-mac-scheduler-simulator.git](https://github.com/alborzbm/5g-mac-scheduler-simulator.git)
    cd 5g-mac-scheduler-simulator
    ```
